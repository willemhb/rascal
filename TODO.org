...
**** TODO change naming style from <snake_case>_t to <camelCase>
**** TODO reorganize object model code into one file
**** TODO update type system to use fixed set of VM types, eliminate dispatch system
**** TODO update vm stack frames to be more similar to Crafting Interpreters
**** TODO update alist/array/table templates to be more similar to `rascal2`
