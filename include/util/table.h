...
size_t adjust_buffer_size(size_t oc, size_t nc, size_t mc, ResizeAlgorithm algo);
size_t adjust_stack_size(size_t oc, size_t nc, size_t mc, ResizeAlgorithm algo);
